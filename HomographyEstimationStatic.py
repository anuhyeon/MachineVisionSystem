...
cv.imwrite('/Users/an-uhyeon/MachineVisionSystem/afterHomographyEstimation/nonusefindhomo_transformed.jpg',img_temp)

# Black out polygonal area in destination image.
pts_dst_2d = pts_dst[:, :2]
cv.fillConvexPoly(img_dst, pts_dst_2d.astype(int), 0)
cv.imwrite('/Users/an-uhyeon/MachineVisionSystem/afterHomographyEstimation/nonusefindhomo_blank.jpg',img_dst)
