...
line_image = cv2.imread('./aftersobelfilter/result2.jpg', cv2.IMREAD_GRAYSCALE)  # 좌측 차선 픽셀들이 흰색(255)로 표시된 영상
original_image = cv2.imread('./Images/lanes.bmp')
right_image = cv2.imread('./aftersobelfilter/result2.jpg')
...
# plt.axis('off')
# plt.title("Original Image with Fitted Line (Left Lane)")
# plt.show()

# cv2.imwrite('./aftersobelfilter/right_lane_fitting2.jpg',output_image)
